...
There are a few parts of the application that applicants submit for acceptance to graduate schools. This assignment will look at GRE score, GPA, and the rank of the undergraduate institution. 
  ...
  The data used was a set of 400 undergraduate students who applied to graduate programs. The data includes whether or not the student was accepted, what was the rank of their undergraduate institution where rank 1 is considered "top tier", their GRE score, and GPA. 
...
## Conclusion
  A higher GPA and GRE score look as though they do raise a student's chance of getting into graduate school. However, it looks like if a student is in a rank 1 and rank 2 schools start with a better chance than those who attended a rank 3 or 4 undergraduate school. 
